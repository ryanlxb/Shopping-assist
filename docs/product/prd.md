...
- [x] STORY-002: 修复 P1 — URL 编码 + N+1 查询 + 路径安全 ✅
- [x] STORY-003: 平台适配器抽象层 — 统一爬虫接口 ✅
- [x] STORY-005: 配料黑名单/白名单管理 ✅

### Next (Sprint 4-8): 差异化
> 跨平台比价和智能配料分析是核心竞争力。
- [x] STORY-004: 淘宝/天猫平台接入 ✅
- [x] STORY-006: 配料安全评级 ✅
- [x] STORY-007: 跨平台商品比价视图 ✅
- [x] STORY-009: 商品收藏与对比清单 ✅
- [x] STORY-010: 搜索结果排序 ✅

### Later (Sprint 9+): 扩展
> 高级功能，依赖数据积累。
- [x] STORY-008: 历史价格追踪与趋势图 ✅
- [x] STORY-011: 基于配料偏好的商品推荐 ✅
